// All 23 Oscar categories with nominees and current Polymarket odds
...
export const CATEGORIES = [
  // ===== THE BIG 8 =====
  {
    ...
    nominees: [
      { id: "bp-1", name: "One Battle After Another", meta: "Paul Thomas Anderson", odds: 0.72 },
      { id: "bp-2", name: "Sinners", meta: "Ryan Coogler", odds: 0.18 },
      { id: "bp-3", name: "Hamnet", meta: "Chloé Zhao", odds: 0.04 },
      { id: "bp-4", name: "Marty Supreme", meta: "Josh Safdie", odds: 0.02 },
      { id: "bp-5", name: "Sentimental Value", meta: "Joachim Trier", odds: 0.015 },
      { id: "bp-6", name: "Frankenstein", meta: "Guillermo del Toro", odds: 0.01 },
      { id: "bp-7", name: "The Secret Agent", meta: "Kleber Mendonça Filho", odds: 0.005 },
      { id: "bp-8", name: "Bugonia", meta: "Yorgos Lanthimos", odds: 0.005 },
      { id: "bp-9", name: "F1", meta: "Joseph Kosinski", odds: 0.003 },
  ...
  },
  {
    ...
    nominees: [
      { id: "bd-1", name: "Paul Thomas Anderson", meta: "One Battle After Another", odds: 0.87 },
      { id: "bd-2", name: "Ryan Coogler", meta: "Sinners", odds: 0.11 },
      { id: "bd-3", name: "Chloé Zhao", meta: "Hamnet", odds: 0.01 },
      { id: "bd-4", name: "Josh Safdie", meta: "Marty Supreme", odds: 0.005 },
      { id: "bd-5", name: "Joachim Trier", meta: "Sentimental Value", odds: 0.005 },
    ]
  },
  {
    id: "best-actor",
    ...
    nominees: [
      { id: "ba-1", name: "Timothée Chalamet", meta: "Marty Supreme", odds: 0.75 },
      { id: "ba-2", name: "Leonardo DiCaprio", meta: "One Battle After Another", odds: 0.11 },
      { id: "ba-3", name: "Michael B. Jordan", meta: "Sinners", odds: 0.07 },
  ...
  },
  {
    ...
    nominees: [
      { id: "bac-1", name: "Jessie Buckley", meta: "Hamnet", odds: 0.88 },
      { id: "bac-2", name: "Emma Stone", meta: "Bugonia", odds: 0.05 },
      { id: "bac-3", name: "Renate Reinsve", meta: "Sentimental Value", odds: 0.04 },
      { id: "bac-4", name: "Tessa Thompson", meta: "Hedda Gabler", odds: 0.02 },
      { id: "bac-5", name: "Cynthia Erivo", meta: "Wicked: For Good", odds: 0.01 },
    ]
  },
  {
    ...
    nominees: [
      { id: "bsa-1", name: "Stellan Skarsgård", meta: "Sentimental Value", odds: 0.71 },
      { id: "bsa-2", name: "Benicio Del Toro", meta: "One Battle After Another", odds: 0.12 },
      { id: "bsa-3", name: "Sean Penn", meta: "One Battle After Another", odds: 0.08 },
      { id: "bsa-4", name: "Jacob Elordi", meta: "Frankenstein", odds: 0.05 },
      { id: "bsa-5", name: "Delroy Lindo", meta: "Sinners", odds: 0.04 },
    ]
  },
  {
    ...
    nominees: [
      { id: "bsac-1", name: "Teyana Taylor", meta: "One Battle After Another", odds: 0.72 },
      { id: "bsac-2", name: "Amy Madigan", meta: "One Battle After Another", odds: 0.17 },
      { id: "bsac-3", name: "Wunmi Mosaku", meta: "Sinners", odds: 0.05 },
      { id: "bsac-4", name: "Elle Fanning", meta: "Sentimental Value", odds: 0.03 },
      { id: "bsac-5", name: "Ariana Grande", meta: "Wicked: For Good", odds: 0.03 },
    ]
  },
  {
    ...
    nominees: [
      { id: "bos-1", name: "Sinners", meta: "Ryan Coogler", odds: 0.79 },
      { id: "bos-2", name: "Marty Supreme", meta: "Josh & Benny Safdie", odds: 0.11 },
      { id: "bos-3", name: "Sentimental Value", meta: "Joachim Trier & Eskil Vogt", odds: 0.05 },
      { id: "bos-4", name: "The Alto Knights", meta: "Nicholas Pileggi", odds: 0.03 },
      { id: "bos-5", name: "Wake Up Dead Man", meta: "Rian Johnson", odds: 0.02 },
    ]
  },
  {
    ...
    nominees: [
      ...
      { id: "bas-2", name: "Hamnet", meta: "Chloé Zhao", odds: 0.09 },
      { id: "bas-3", name: "Frankenstein", meta: "Guillermo del Toro", odds: 0.03 },
      { id: "bas-4", name: "Bugonia", meta: "Yorgos Lanthimos", odds: 0.01 },
      { id: "bas-5", name: "Hedda Gabler", meta: "Nia DaCosta", odds: 0.01 },
    ]
  },
  ...
  },
  {
    ...
    nominees: [
      { id: "bif-1", name: "Sentimental Value", meta: "Norway", odds: 0.68 },
      { id: "bif-2", name: "The Secret Agent", meta: "Brazil", odds: 0.29 },
      { id: "bif-3", name: "The Ugly Stepsister", meta: "Denmark", odds: 0.015 },
      { id: "bif-4", name: "Kokuho", meta: "Japan", odds: 0.01 },
      { id: "bif-5", name: "Waves", meta: "Czech Republic", odds: 0.005 },
    ]
  },
  {
  ...
  },
  {
    ...
    nominees: [
      { id: "bc-1", name: "Sinners", meta: "Autumn Durald Arkapaw", odds: 0.66 },
      { id: "bc-2", name: "One Battle After Another", meta: "Unknown", odds: 0.17 },
      { id: "bc-3", name: "Frankenstein", meta: "Dan Laustsen", odds: 0.10 },
      { id: "bc-4", name: "Marty Supreme", meta: "Darius Khondji", odds: 0.04 },
      { id: "bc-5", name: "Hamnet", meta: "Joshua James Richards", odds: 0.03 },
    ]
  },
  {
    ...
    nominees: [
      ...
      { id: "bfe-2", name: "F1", meta: "Unknown", odds: 0.27 },
      { id: "bfe-3", name: "Sinners", meta: "Unknown", odds: 0.08 },
      { id: "bfe-4", name: "Marty Supreme", meta: "Benny Safdie", odds: 0.03 },
      { id: "bfe-5", name: "Sentimental Value", meta: "Unknown", odds: 0.02 },
    ]
  },
  {
  ...
  },
  {
    ...
    nominees: [
      { id: "bcd-1", name: "Frankenstein", meta: "Luis Sequeira", odds: 0.85 },
      { id: "bcd-2", name: "Wicked: For Good", meta: "Paul Tazewell", odds: 0.08 },
      { id: "bcd-3", name: "Hamnet", meta: "Unknown", odds: 0.04 },
      { id: "bcd-4", name: "Marty Supreme", meta: "Unknown", odds: 0.02 },
      { id: "bcd-5", name: "Sinners", meta: "Unknown", odds: 0.01 },
    ]
  },
  {
    ...
    nominees: [
      { id: "bmh-1", name: "Frankenstein", meta: "Unknown", odds: 0.88 },
      { id: "bmh-2", name: "Sinners", meta: "Unknown", odds: 0.05 },
      { id: "bmh-3", name: "Wicked: For Good", meta: "Unknown", odds: 0.04 },
      { id: "bmh-4", name: "One Battle After Another", meta: "Unknown", odds: 0.02 },
      { id: "bmh-5", name: "The Ugly Stepsister", meta: "Unknown", odds: 0.01 },
    ]
  },
  {
    ...
    nominees: [
      { id: "bsc-1", name: "Sinners", meta: "Ludwig Göransson", odds: 0.86 },
      ...
      { id: "bsc-5", name: "Bugonia", meta: "Unknown", odds: 0.02 },
    ]
  },
  {
    ...
    emoji: "🎤",
    polymarketSlug: "oscars-2026-best-original-song-winner",
    nominees: [
  ...
  },
  {
    ...
    emoji: "🎞️",
    polymarketSlug: "oscars-2026-best-documentary-short-film-winner",
    nominees: [
